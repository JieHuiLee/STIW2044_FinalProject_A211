  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Payment',
              style: TextStyle(
                color: const Color.fromRGBO(178, 35, 52, 1),
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              width: 300,
                              child: Text(
                                  "Pickup time daily from 8.00 A.M to 8.00 P.M from our shop. Please allow 15-30 minutes to prepare your order before pickup time"),
                            ),
                            SizedBox(
                              height: 7,
                            ),
