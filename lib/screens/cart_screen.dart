...
class _CartScreenState extends State<CartScreen> {
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        "https://fluttermycuckoodb.000webhostapp.com/images/${_cartList[index]['prid']}.png",
                                    height: 300,
                                    width: 300,
                                  ),
                                ),
  ...
  _loadMyCart() {
    http.post(
        Uri.parse(
            "https://fluttermycuckoodb.000webhostapp.com/php/load_user_cart.php"),
  ...
  void _modQty(int index, String action) {
    http.post(
        Uri.parse(
            "https://fluttermycuckoodb.000webhostapp.com/php/update_cart.php"),
        body: {
  ...
  void _deleteCart(int index) {
    http.post(
        Uri.parse(
            "https://fluttermycuckoodb.000webhostapp.com/php/delete_cart.php"),
        body: {
          "email": widget.email,
          "prid": _cartList[index]['prid']
        }).then((response) {
